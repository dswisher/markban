...
- [ ] If the project directory is not specified, look for the git root and try to find a subdirectory with "board" in the name that has a `board.toml` file in it
